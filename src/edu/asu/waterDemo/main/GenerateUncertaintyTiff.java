...
//						CalcStatThread[] calcStatService = new CalcStatThread[tgtWidth];
//						Thread[] calcStatServerThread = new Thread[tgtWidth];
...
//						for(int i1=0; i1<sParserArr.size(); i1++){
//							value[i1] = sParserArr.get(i1).getData()[tgtIndex];
//						}
...
//				}
//			}
//			for(int i1=0; i1<outputfile.length; i1++){
////				write geotiff files
//				Driver driver = gdal.GetDriverByName("GTiff");
//				Dataset dst_ds = driver.Create(outputfile[i1], (int)tgtWidth, (int)tgtHeight, 1, gdalconst.GDT_Float64);
//				dst_ds.SetGeoTransform(sParserArr.get(i1).getGeoInfo());
//				dst_ds.SetProjection(sParserArr.get(i1).getProjRef());
//				double[] curBuffer = bufferSet.get(i1);
